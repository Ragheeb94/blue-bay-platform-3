...
// ─── Category definitions (Numotion-style) ────────────────────────────────────

const primaryCategories = [
  {
    slug: "manual-wheelchairs" as ProductCategory,
    label: "Manual Wheelchairs",
    desc: "Your mobility chair options can be overwhelming, but we can help you along the way. Discover the best custom wheelchair options that fit your lifestyle and needs — from ultralight titanium frames to sport and everyday configurations.",
  ...
  },
  {
    ...
    desc: "We provide a wide range of power wheelchairs tailored to meet your unique needs and lifestyle. From complex chairs with advanced positioning features to compact models for everyday use, our power wheelchair solutions offer independence, comfort, and control.",
    image: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=900&q=80&fit=crop",
...
// ─── Product tile (Numotion subcategory-tile style) ───────────────────────────
...
// ─── Landing view (Numotion /adult-mobility-solutions replica) ────────────────

function LandingView() {
  return (
    <>
      {/* Hero — Numotion-style light blue, large heading */}
      <section style={{ background: "#EEF4FA" }} className="relative overflow-hidden">
        {/* Decorative watermark */}
        <div className="absolute right-[-2rem] top-0 bottom-0 flex items-center select-none pointer-events-none" aria-hidden>
          <span className="text-[22rem] font-black leading-none opacity-[0.04]" style={{ color: "var(--navy)" }}>BB</span>
        </div>
        <div className="container py-20 md:py-28 relative z-10">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-5" style={{ color: "var(--navy)" }}>
              Adult mobility solutions
            </h1>
            <p className="text-gray-500 text-lg max-w-lg leading-relaxed">
              Our complex mobility solutions are tailored to your body and your needs.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {/* Primary category sections — alternating image + text (Numotion style) */}
      ...
      {/* Adaptive living essentials — Numotion-style dark section with grid */}
      ...
      {/* How it works strip — Numotion 4-step */}
      ...
      {/* Support CTA — Numotion customer support style */}
...
// ─── Category view (Numotion product-categories page replica) ─────────────────
...
function CategoryView({ category }: { category: ProductCategory }) {
  ...
  return (
    <>
      ...
      {/* Category hero — image-backed like Numotion category pages */}
