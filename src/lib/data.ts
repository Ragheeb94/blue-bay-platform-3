...
// ─── Shop / Liberty Care product types ───────────────────────────────────────
...
export const shopProducts: ShopProduct[] = [
  {
    slug: "shop-pride-go-go-elite",
    name: "Pride Go-Go Elite Traveller (3-Wheel)",
    brand: "Pride Mobility",
    category: "scooters",
    categoryLabel: "Scooters",
    tagline: "Disassembles into 5 pieces for easy transport",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80&fit=crop",
    price: 1499,
    priceLabel: "$1,499",
    inStock: true,
    badges: ["In Stock", "Ships in 3–5 days"],
    specs: [
      { label: "Weight", value: "46 lbs (heaviest piece: 26 lbs)" },
      { label: "Range", value: "Up to 8.5 miles" },
      { label: "Max Speed", value: "4 mph" },
      { label: "Weight Capacity", value: "300 lbs" },
    ],
    description:
      "The lightest disassembling travel scooter from Pride Mobility. Feather-touch disassembly into 5 pieces, anti-tip wheels, and automatic feathering.",
  },
  {
    slug: "shop-future-4-wheel-rollator",
    name: "Future Mobility 4-Wheel Rollator",
    brand: "Future Mobility",
    category: "walkers",
    categoryLabel: "Walkers & Rollators",
    tagline: "Padded seat, underseat basket, loop-lock brakes",
    image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&q=80&fit=crop",
    price: 189,
    priceLabel: "$189",
    inStock: true,
    badges: ["In Stock", "Ships in 1–2 days"],
    specs: [
    ...
    description:
      "Everyday 4-wheel rollator with padded seat for rest breaks and underseat storage basket. Aluminum frame folds flat for transport.",
  },
  {
    slug: "shop-future-bath-transfer",
    name: "Future Mobility Bath Transfer Bench",
    brand: "Future Mobility",
    category: "transfer",
    categoryLabel: "Transfer Aids",
    tagline: "Sliding seat for safe bathtub transfers",
    image: "https://images.unsplash.com/photo-1584998604882-94bf3d6e3b0e?w=600&q=80&fit=crop",
    price: 299,
    priceLabel: "$299",
    inStock: true,
    badges: ["In Stock", "Ships in 2–3 days"],
    specs: [
      { label: "Weight Capacity", value: "400 lbs" },
      { label: "Material", value: "Anodized aluminum" },
      { label: "Adjustable Height", value: "14–22 inches" },
      { label: "Folding", value: "Yes" },
    ],
    description:
      "Straddles the bathtub edge — sit outside, slide in. Padded backrest and adjustable height for various tub configurations.",
  },
  {
    slug: "shop-future-folding-walker",
    name: "Future Mobility Folding Walker",
    brand: "Future Mobility",
    category: "walkers",
    categoryLabel: "Walkers & Rollators",
    tagline: "5.5 lb aluminum 2-wheel walker — lightest in class",
    image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&q=80&fit=crop",
    price: 79,
    priceLabel: "$79",
    inStock: true,
    badges: ["In Stock", "Ships same day"],
    specs: [
    ...
    description:
      "The lightest full-size aluminum folding walker. Front wheels reduce floor friction for smooth indoor movement. Folds flat for storage.",
  },
  {
    slug: "shop-roho-quadtro",
    name: "ROHO Quadtro Select Cushion",
    brand: "ROHO",
    category: "seating",
    categoryLabel: "Seating & Positioning",
    tagline: "4-zone independent air cell cushion",
    image: "https://images.unsplash.com/photo-1584145798265-b286d367426f?w=600&q=80&fit=crop",
    price: 549,
    priceLabel: "$549",
    inStock: true,
    badges: ["In Stock", "Insurance Eligible"],
    specs: [
      { label: "Zones", value: "4 independently adjustable" },
      { label: "Cell Height", value: "2 inch (standard)" },
      { label: "Sizes", value: "14–22 inches" },
      { label: "Cover", value: "Stretch-air permeable" },
    ],
    description:
      "Clinical-grade air cell cushion for pressure management. Setup and inflation instructions included. Insurance documentation available on request.",
  },
  {
    slug: "shop-future-carbon-rollator",
    name: "Future Mobility Carbon Rollator",
    brand: "Future Mobility",
    category: "walkers",
    categoryLabel: "Walkers & Rollators",
    tagline: "Under 5 lbs — lightest clinical rollator available",
    image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&q=80&fit=crop",
    price: 549,
    priceLabel: "$549",
    inStock: false,
    badges: ["Pre-order", "Ultralight"],
    specs: [
    ...
    description:
      "Carbon fibre frame weighing under 5 lbs. The lightest rollator in our catalog. Available for pre-order — ships in 2–3 weeks.",
  },
];
